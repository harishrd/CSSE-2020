...
int main()
{
	...
	{
        printf("\n\t1 To see list\n");
        printf("\t2  to insert at starting\n"); //   insertion can be put into a single switch case
        ...
        printf("\t7  to delete a element at any position\n");
        ...
        printf("\t12 To search an element\n");
        printf("\t13 To exit\n");
        printf("\nEnter Choice :\n");
        scanf("%d", &choice);
